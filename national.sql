...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 01, 2023 at 03:34 PM
...
INSERT INTO `about_main` (`id`, `title`, `title_ar`, `icon`, `content`, `content_ar`) VALUES
(1, 'Get everything you need to pick the right Agent', 'احصل على كل ما تحتاجه لاختيار الوكيل المناسب', '1', '', ''),
(2, 'Modern Residence', 'الإقامة الحديثة', 'fa-building', 'Integer sit amet mattis quam, sit amet ultricies velit. Praesent ullamcorper dui turpis.', 'الجلوس الصحيح امات ماتيس quam، والجلوس امات ultricies velit. Ullamcorper دوى الحالي قبيحة.'),
(3, 'Development Services', 'خدمات التطوير', 'fa-address-card', 'Integer sit amet mattis quam, sit amet ultricies velit. Praesent ullamcorper dui turpis.', 'الجلوس الصحيح امات ماتيس quam، والجلوس امات ultricies velit. Ullamcorper دوى الحالي قبيحة.'),
(4, 'Property Management', 'إدارة الممتلكات', 'fa-building', 'Integer sit amet mattis quam, sit amet ultricies velit. Praesent ullamcorper dui turpis.', 'الجلوس الصحيح امات ماتيس quam، والجلوس امات ultricies velit. Ullamcorper دوى الحالي قبيحة.');
...
INSERT INTO `contact` (`id`, `content`, `content_ar`, `map`) VALUES
...
(7, 'goog', NULL),
(8, 'in', NULL),
(9, 'address_ar', 'مدينة نصر , القاهرة');
...
INSERT INTO `main` (`id`, `title`, `title_ar`, `content`, `content_ar`, `image`, `background`, `show`) VALUES
(1, 'Energy Bridges For Electro Mechanic “EBEM”', 'جسور الطاقة لكهربائي ميكانيكي \"EBEM\"', 'is one of the leading electro mechanical contractors in KSA with its established sister company in Egypt', 'هي واحدة من المقاولين الكهربائيين الكهربائيين الرائدين في المملكة العربية السعودية مع شركتها الشقيقة في مصر', 'Main.jpg', 'banner.jpg', 1);
...
CREATE TABLE `projects` (
  ...
  `address_ar` varchar(150) NOT NULL,
  `el1` varchar(30) NOT NULL,
  `el2` varchar(30) NOT NULL,
  `el3` varchar(30) NOT NULL,
  `el4` varchar(30) NOT NULL,
  `el1ar` varchar(30) NOT NULL,
  `el2ar` varchar(30) NOT NULL,
  `el3ar` varchar(30) NOT NULL,
  `el4ar` varchar(30) NOT NULL,
  `content` text NOT NULL,
  `content_ar` text NOT NULL,
  `el1con` varchar(150) NOT NULL,
  `el2con` varchar(150) NOT NULL,
  `el3con` varchar(150) NOT NULL,
  `el4con` varchar(150) NOT NULL,
  `el1conar` varchar(150) NOT NULL,
  `el2conar` varchar(150) NOT NULL,
  `el3conar` varchar(150) NOT NULL,
  `el4conar` varchar(150) NOT NULL,
  `by` int(255) UNSIGNED NOT NULL DEFAULT 0,
  `image` text DEFAULT NULL,
  `time` varchar(60) NOT NULL,
  `time_ar` varchar(60) NOT NULL,
...
CREATE TABLE `tistimonials` (
  ...
  `company_ar` varchar(60) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `tistimonials` (`id`, `name`, `name_ar`, `image`, `content`, `content_ar`, `company`, `company_ar`) VALUES
...
(1, 'admin@touch.com', '$2y$10$Spo3s69S8CysX8968CjtP.ZTFdabjT8GVbVXjsVXgvAIGPjta5/v.', NULL);
...
INSERT INTO `wedo` (`id`, `title`, `title_ar`, `content`, `content_ar`, `font`) VALUES
(1, 'Our Featured Service', 'لدينا خدمة مميزة', 'wedo.jpg', '', ''),
(2, 'For Renters', 'للإيجار', 'Integer sit amet mattis quam, sit amet ultricies velit. Praesent ullamcorper dui turpis.', 'الجلوس الصحيح امات ماتيس quam، والجلوس امات ultricies velit. Ullamcorper دوى الحالي قبيحة.', 'fa-building');
